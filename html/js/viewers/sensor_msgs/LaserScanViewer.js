...
class LaserScanViewer extends Viewer {
  ...
  addTopic(topic) {
    ...
    this.listeners[topic] = new ROS3D.LaserScan({
        ros: ros,
        topic: topic,
...
LaserScanViewer._TYPE = 'sensor_msgs/LaserScan';
addViewer(LaserScanViewer);
