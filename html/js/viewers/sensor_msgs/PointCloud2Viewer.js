...
class PointCloud2Viewer extends Viewer {
  ...
  addTopic(topic) {
    ...
    this.listeners[topic] = new ROS3D.PointCloud2({
        ros: ros,
        topic: topic,
...
PointCloud2Viewer._TYPE = 'sensor_msgs/PointCloud2';
addViewer(PointCloud2Viewer);
